...
def MUCRlib(use_gpu=False):
    ...
    key_str="SHOULDER"
    dataset={"train":datamanager(root="./MURA-v1.1/train_labeled_studies.csv",key_str=key_str,transform=Transform),
            "valid": datamanager(root="./MURA-v1.1/valid_labeled_studies.csv",key_str=key_str,transform=Transform)}
